import {Container, Title, InfoAndImg, Img, Info, SVG} from '../styles/pages/MobileIntoleranciaAlimentar.styles'
import { Footer } from "../components/Web/footer/Footer";
import { Link } from "react-router-dom";
import { useEffect } from "react";

export default function MobileIntoleranciaAlimentar(){
