...
export function MobileMethod(){
    return(
        <Container>
            <h1>Método</h1>
            <img src="https://lirp.cdn-website.com/4dd4966b/dms3rep/multi/opt/photo-1470167290877-7d5d3446de4c-bba841ec-1920w.jpg" alt="método" />
